...
$headers = 	'Bcc: '.$list.'\r\n'.
			...
			'Reply-To: '.$from."\r\n". 
			'List-ID: UberBots Email Pipe <'.$group.'.uberbots.org>'. "\r\n" . 
...
$htmlMessage .= "<br/><div>This message was sent by ".$from.".<br/>This message forwarded by UberBots' email piping.</div>";


mail("plnyyanks@gmail.com",$subject,$htmlMessage,$headers)or die("Mail Sending Failed".$list);
