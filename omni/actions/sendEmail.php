...
$footer = "<br/><p>This message was sent by the &Uuml;berBots mass email system. If you are receiving this message in error, please email <a href='mailto:unsubscribe@uberbots.org'>unsubscribe@uberbots.org</a>. If you wish to remove yourself from the list manually, follow the instructions <a href='http://uberbots.org/o/Resources/Email_List_Sign_Up'>here</a>. If you have other questions or comments, please email the <a href='mailto:webmaster@uberbots.org'>webmaster</a>.</p><p>Please do not reply to this message.</p>";

//make headers
$head = 'List-ID: UberBots Mass Emails <massEmail.uberbots.org>'. "\r\n" . 
		'List-Owner: <mailto:webmaster@uberbots.org>' . "\r\n" .
		'List-Unsubscribe: <http://uberbots.org/o/Resources/Email_List_Sign_Up>,<mailto:unsubscribe@uberbots.org>' . "\r\n" . 
		'List-Help: <mailto:webmaster@uberbots.org>' ."\r\n".
		'X-Mailer: PHP/' . phpversion() ."\r\n".
		'X-Unsubscribe-Email: <mailto:unsubscribe@uberbots.org>' . "\r\n" . 
		'X-Unsubscribe-Web: <http://uberbots.org/o/Resources/Email_List_Sign_Up>'."\r\n".
		'Precedence: bulk'."\r\n".
...
//add in other recipients
$list .= $_POST['otherEmails'];


$subject = $_POST['subject'];
//mail message if admin is signed in
if(userPermissions(1,2)&&!isset($_GET["calendar"])){
	$mail = mail("",$_POST["subject"],$message,$head.$list) or die("Mail sending failed");
	...
	if($mail){
		//mail("plnyyanks@gmail.com",$_POST['subject']."-confirm",$message."<br/>".$head,"Content-type: text/html;");
