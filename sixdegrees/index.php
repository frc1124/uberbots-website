...
function sniffTeam($refTeam,$steps){
...
<body>
<div style="top:20%;text-align:center;position:absolute;width:100%;background-color:rgba(0,0,0,.5);filter:alpha(opacity=50)">
...
<p>Options:</p>
<input type="checkbox" name="winning" /> Winning <br/>
<input type="checkbox" name="elim" /> Elimination Matches <br/>
<select name="year">
<?/*
$q = mysql_query("SELECT DISTINCT years FROM events");
